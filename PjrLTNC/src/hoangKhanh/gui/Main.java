...
import hoangkhanh.controllers.KhuPhoController;
import hoangkhanh.models.KhuPho;
...
//========================================================================
	 ...
	 */
	public Main() {
		setTitle("Chương trình quản lý khu phố");
		...
		JLabel lblFromSeasideTo = new JLabel("Bài thi cuối kỳ LTNC- Hoàng Việt Khánh - 20182600");
		lblFromSeasideTo.setForeground(new Color(139, 220, 255));
		lblFromSeasideTo.setFont(new Font("Times New Roman", Font.BOLD | Font.ITALIC, 18));
		panel.add(lblFromSeasideTo);
		
		JLabel lblNhpMKhu = new JLabel("Nhập vào mã khu phố để thực hiện:");
		lblNhpMKhu.setFont(new Font("Times New Roman", Font.PLAIN, 18));
		lblNhpMKhu.setBounds(35, 47, 350, 30);
		contentPane.add(lblNhpMKhu);
		
		textField = new JTextField();
		textField.setBounds(426, 49, 200, 30);
		contentPane.add(textField);
		textField.setColumns(10);
		
		JButton btnNewButton_2 = new JButton("Sửa");
		btnNewButton_2.setFont(new Font("Tahoma", Font.PLAIN, 18));
		btnNewButton_2.setBounds(678, 45, 120, 40);
		...
		btnNewButton_3.setBounds(828, 45, 120, 40);
...
//					}
		...
		JMenuItem mntmHongHip = new JMenuItem("Hoang Khanh");
		mntmHongHip.setFont(new Font("Segoe UI", Font.PLAIN, 14));
		mntmHongHip.addActionListener(new ActionListener() {
			
			@Override
			public void actionPerformed(ActionEvent e) {
				JOptionPane.showMessageDialog(null, "Sinh viên: Hoàng Việt Khánh - 20182600", "Bài cuối kỳ môn lập trình nâng cao", JOptionPane.INFORMATION_MESSAGE);
