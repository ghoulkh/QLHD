package hoangkhanh.controllers;
...
import hoangkhanh.models.HoDan;
import hoangkhanh.models.KhuPho;
import hoangkhanh.models.Nguoi;
...
public class KhuPhoController {
	...
	public static void main(String[] args) {
		// testing
		Nguoi ng = new Nguoi("NG19", "Nguyen A", 35, 1987, "VDV", "HD07");
		HoDan hd = new HoDan("HD15", 51, 3, "KP05");
	...
	public boolean addHoDan(HoDan hd) {
		boolean flag = true;
		try {
			String sql2 = "insert into hodan (maHoDan, soNha, soThanhVien,  maKhuPho) values ( ? , ? , ? , (select maKhuPho from khupho where maKhuPho = ? ))";
